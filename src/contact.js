        ...
        <div className="contactdiv">
            ...
            <div className="detailsdiv">
                <div className="detail">
                    <div className="detaillogo"><img src={gmail} alt="Gmail icon"/></div>
                ...
                <div className="detail">
                    <div className="detaillogo"><img src={linkedin} alt="LinkedIn icon"/></div>
                ...
                <div className="detail">
                    <div className="detaillogo"><img src={github} alt="GitHub icon"/></div>
                    <div><a href="https://github.com/Shakeel2k-5/" className="detailcontent">https://github.com/Shakeel2k-5/</a></div>
                </div>
                <div className="detail">
                    <div className="detaillogo"><img src={leetcode} alt="LeetCode icon"/></div>
